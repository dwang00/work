...
KREWES = {
    'orpheus': ['Emily', 'Kevin', 'Vishwaa', 'Eric', 'ray', 'Jesse', 'Tiffany'
                ...
                'Hong Wei', 'Michael', 'Kiran', 'Amanda', 'Joseph', 'Tanzim',
                'David', 'Yevgeniy'],
    ...
    'endymion': ['Grace', 'Nahi', 'Derek', 'Jun Tao', 'Connor', 'Jason',
                 'Tammy', 'Albert', 'Kazi', 'Derek', 'Brandon', 'Kenneth',
                 'Lauren', 'Biraj', 'Jeff', 'Jackson', 'Taejoon', 'Kevin',
                 'Jude', 'Sophie', 'Henry', 'Coby', 'Manfred', 'Leia', 'Ahmed',
                 'Winston']
    }
def pick():
    print(random.choice(KREWES[random.choice(['orpheus', 'rex', 'endymion'])]))
